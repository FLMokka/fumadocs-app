...
import { CodeBlock as PrimitiveCodeBlock } from "react-code-block";
...
export function CodeBlock({
  ...
  return (
    <div
      className={cn(
        "w-full overflow-hidden text-sm border rounded-xl font-mono leading-6",
        className
      )}
      {...props}>
      <Accordion
            ...
            <PrimitiveCodeBlock code={code} language={language} theme={theme}>
              <PrimitiveCodeBlock.Code
                ...
                <div className="flex flex-row">
                  <PrimitiveCodeBlock.LineNumber className="opacity-50 pr-4 select-none" />
                  <PrimitiveCodeBlock.LineContent className="pl-2">
                    <PrimitiveCodeBlock.Token />
                  </PrimitiveCodeBlock.LineContent>
                </div>
              </PrimitiveCodeBlock.Code>
            </PrimitiveCodeBlock>
          </AccordionContent>
